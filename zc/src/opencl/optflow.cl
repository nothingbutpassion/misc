...
#define rmat8uc4(addr, x, y)	((__global const uchar4*)(((__global const uchar*)addr) + mad24(addr##_step, (y), addr##_offset)))[x]
#define rmat32fc1(addr, x, y)   ((__global const float*)(((__global const uchar*)addr) + mad24(addr##_step, (y), addr##_offset)))[x]
#define rmat32fc2(addr, x, y)   ((__global const float2*)(((__global const uchar*)addr) + mad24(addr##_step, (y), addr##_offset)))[x]
#define wmat32fc1(addr, x, y) 	((__global float*)(((__global uchar*)addr) + mad24(addr##_step, (y), addr##_offset)))[x]
#define wmat32fc2(addr, x, y) 	((__global float2*)(((__global uchar*)addr) + mad24(addr##_step, (y), addr##_offset)))[x]
